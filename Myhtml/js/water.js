...
//动态创建img添加到li里面
var arr =[
   {src:"../../picture/7_img1/1.png"},//json写法
   {src:"../../picture/7_img1/2.jpg"},
   {src:"../../picture/7_img1/3.jpg"},
   {src:"../../picture/7_img1/4.jpg"},
   {src:"../../picture/7_img1/5.jpg"},
   {src:"../../picture/7_img1/6.jpg"},
   {src:"../../picture/7_img1/7.jpg"},
   {src:"../../picture/7_img1/8.jpg"},
   {src:"../../picture/7_img1/9.jpg"},
   {src:"../../picture/7_img1/10.jpg"},
   {src:"../../picture/7_img1/11.jpg"},
   {src:"../../picture/7_img1/12.jpg"}
];
//create();
...
$(window).scroll(function(){//滚动条高度发生变化，就触发
     ...
     if((_height + scrollT+250 > scrollH )&&(_height + scrollT<6400)){
           onload();
