//百度换肤系统start
    ...
    var oA = document.getElementsByClassName('a2');//多个//换肤按钮
//alert("huanying")
    var oDic = document.getElementById('dic');
    

    var oLi = oDic.getElementsByTagName('li');//多个
    var oBody = document.getElementsByTagName('body');//多个加中括号
    var onOff = true;
    var index = 0;
...
oBody[0].style.background = 'url('+oSrc+')';
