...
//动态创建img添加到li里面
var arr =[
   {src:"/dw/picture/7_img1/1.png"},//json写法
   {src:"/dw/picture/7_img1/2.jpg"},
   {src:"/dw/picture/7_img1/3.jpg"},
   {src:"/dw/picture/7_img1/4.jpg"},
   {src:"/dw/picture/7_img1/5.jpg"},
   {src:"/dw/picture/7_img1/6.jpg"},
   {src:"/dw/picture/7_img1/7.jpg"},
   {src:"/dw/picture/7_img1/8.jpg"},
   {src:"/dw/picture/7_img1/9.jpg"},
   {src:"/dw/picture/7_img1/10.jpg"},
   {src:"/dw/picture/7_img1/11.jpg"},
   {src:"/dw/picture/7_img1/12.jpg"}
];
//create();
...
$(window).scroll(function(){//滚动条高度发生变化，就触发
     ...
     if((_height + scrollT+250> scrollH) && (_height + scrollT<1400) ){
           onload();
